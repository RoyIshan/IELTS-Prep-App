...
public class ReadingMCQTopics extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(ReadingMCQTopics.this,"Ni chal ra",Toast.LENGTH_SHORT).show();
                        }
                    }
                });
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(ReadingMCQTopics.this, ReadingMCQEachPara.class);
                intent.putExtra("paraNo",selectedItem);
                startActivity(intent);
                Toast.makeText(ReadingMCQTopics.this, selectedItem + " clicked", Toast.LENGTH_SHORT).show();
            }
        });
    }
}